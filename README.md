...
matching sizes re-select their preset), and a map-atlas size (the glyph texture the story map bakes, 128–4096, default 1024); *Audio*: master, music, voice and SFX volumes
