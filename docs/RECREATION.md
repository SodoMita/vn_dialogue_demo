...
- **Portrait sprites**: authored landscape offsets stay. Only when the logical view is taller than it is wide, enlarge the rects and spread their centers. The speaking sprite gets the higher `z_index`.
